	...
	public class MainViewModel : Screen
	{
		...
		public MainViewModel()
		{
			...
			try
			{
				...
				var p = httpClient.GetFromJsonAsync<GitVersion>("https://api.github.com/repos/ianespana/ShawzinBot/releases/latest").ConfigureAwait(false).GetAwaiter().GetResult();
		...
		{
			Scale = "Scale: " + _scaleArray[scaleIndex];
		}
